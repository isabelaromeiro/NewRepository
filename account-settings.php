...
<?php $userInfo = retrieve_info("user", get_id())->fetch_array(MYSQLI_BOTH); ?>
...
<div class="col-md-offset-4 col-md-4">
	<form id="product_form" action="account-settings.php" method="post" enctype="multipart/form-data" onsubmit="return validateAll();">
		...
		<div class="form-group col-md-12">
			...
			<?php echo "<input type='text' value='" . $userInfo['phone_number'] . "' class='form-control' id='phone_number' name='phone_number' placeholder='User phone number'>" ?>
		</div>
		<div class="form-group col-md-12">
